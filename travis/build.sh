...
if [[ "$TRAVIS_PULL_REQUEST" != "false" ]]; then     # pull request
    ...
    openssl aes-256-cbc -K $encrypted_d4d8881fb4c9_key -iv $encrypted_d4d8881fb4c9_iv -in $TRAVIS_BUILD_DIR/travis.json.enc -out $TRAVIS_BUILD_DIR/travis.json -d
    openssl aes-256-cbc -K $encrypted_d4d8881fb4c9_key -iv $encrypted_d4d8881fb4c9_iv -in $TRAVIS_BUILD_DIR/sagebio.jks.enc -out $TRAVIS_BUILD_DIR/sagebio.jks -d
